...
/**
 * Computes centered bounds for a window inside a display work area.
 *
 * Before:
 * - Window size exists but no initial x/y is provided
 *
 * After:
 * - The window opens centered inside the target work area
 */
