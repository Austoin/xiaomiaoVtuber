  ...
  <div :class="['flex flex-col gap-6']">
    ...
    <section :class="['border-t border-neutral-200 pt-4 dark:border-neutral-800']">
      ...
      <div :class="['flex flex-col gap-2 text-sm text-neutral-600 dark:text-neutral-300']">
        ...
        <code :class="['w-fit rounded-md bg-neutral-950/90 px-2 py-1 text-xs text-neutral-100']">docs/guide/INTEGRATIONS.md</code>
      </div>
    </section>
    ...
    <section :class="['border-t border-neutral-200 pt-4 dark:border-neutral-800']">
      ...
      <div :class="['grid gap-3 text-sm text-neutral-600 dark:text-neutral-300']">
        ...
        <div>
          ...
          <pre :class="['mt-2 whitespace-pre-wrap rounded-lg bg-neutral-950/90 p-3 text-xs text-neutral-100']">{{ latestRuntimeContextText || t('settings.pages.modules.gaming-minecraft.runtime.waiting') }}</pre>
        </div>
      </div>
    </section>
    ...
    <section :class="['border-t border-neutral-200 pt-4 dark:border-neutral-800']">
      ...
      <div v-else :class="['flex flex-col gap-3']">
        <div
          ...
          :key="entry.id"
          :class="['rounded-lg border border-neutral-200 bg-white/80 p-3 dark:border-neutral-800 dark:bg-black/20']"
        >
