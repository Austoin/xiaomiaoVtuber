...
本文是 `docs/archive/plans/` 的中文索引，用于区分历史计划、已完成实施记录和仍需继续推进的能力缺口。当前运行方式、配置和验收命令以 `docs/00-quick-start/run-and-config.md`、`docs/getting-started/README.md`、`docs/04-development/verification.md` 为准。
