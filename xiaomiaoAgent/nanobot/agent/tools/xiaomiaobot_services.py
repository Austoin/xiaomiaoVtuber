...
DEFAULT_BRIDGE_EVENTS_URL = "http://127.0.0.1:8900/v1/xiaomiao/events"
DEFAULT_BRIDGE_STATUS_URL = "http://127.0.0.1:8900/health"
...
def _status_summary(status: dict[str, Any]) -> str:
    ok = bool(status.get("ok")) or status.get("status") == "ok"
    service = status.get("service") or "xiaomiaoAgent"
