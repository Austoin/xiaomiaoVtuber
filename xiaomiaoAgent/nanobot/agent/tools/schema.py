"""JSON Schema fragment types for xiaomiaoAgent tool parameters.

- ``to_json_schema()``: returns a dict compatible with the canonical Schema and Tool contracts.
...
Shared validation and fragment normalization are on the Schema class methods.
