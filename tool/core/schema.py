"""JSON Schema fragment types: all subclass :class:`~tool.core.base.Schema` for descriptions and constraints on tool parameters.

- ``to_json_schema()``: returns a dict compatible with :meth:`~tool.core.base.Schema.validate_json_schema_value` /
  :class:`~tool.core.base.Tool`.
...
Shared validation and fragment normalization are on the class methods of :class:`~tool.core.base.Schema`.
...
from tool.core.base import Schema
